...
Som fallback genkendes den eksakte badge-tekst på en lille liste over YouTube-badgecontainere, herunder både den ældre `yt-badge-shape` og den aktuelle `badge-shape` markup. Både “Members only” og YouTubes early-access-badge “Members first” genkendes. Matchene er forankret til hele teksten, så en normal videotitel som “Our members first preview is now public” ikke bliver skjult.
